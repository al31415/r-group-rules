...
- Чтобы правильно задать вопрос, помогает следующий прием. Представьте, что Вы задаете вопрос своему коллеге, который очень занят и Вам нужно сформулировать вопрос одним-двумя предложениями, включив в него всю необходимую информацию, чтобы идентифицировать проблему и если получится, то решить ее. 
